...
def trainLSTM(data_dir, epochs, seed=422, data=None, **kwargs):
    ...
    if len(encoder_units) > 0:
        ...
        encoder_stack, state_h, state_c = LSTM(last_unit_encoder, return_sequences=True, return_state=True, name='LSTM_EnFin')(outputs)
    else:
        encoder_stack, state_h, state_c = LSTM(first_unit_encoder, return_sequences=True, return_state=True, name='LSTM_En')(encoder_inputs)
